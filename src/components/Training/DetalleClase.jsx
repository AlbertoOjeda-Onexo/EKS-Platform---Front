...
import "../../styles/Components/DetalleLesson.css";
...
export default function DetalleLesson({ lesson }) {
  ...
  return (
    <div>
      <Descriptions title="Información general" bordered size="small" column={1}>
        <Descriptions.Item label="Título">{lesson.title}</Descriptions.Item>
        ...
        <Descriptions.Item label="Estado">
          <Tag color="blue">{lesson.status}</Tag>
        </Descriptions.Item>
      </Descriptions>
      ...
      <div className="campos-personalizados-scroll">
        <Descriptions bordered size="small" column={1}>
          {lesson.dynamic_values?.map((campo) => (
